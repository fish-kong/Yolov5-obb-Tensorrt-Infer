...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/yolov5obb_demo.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/tomato/train/exp8/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[512, 512], help='image (h, w)')
